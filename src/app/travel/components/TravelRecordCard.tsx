...
export function TravelRecordCard({ record }: TravelRecordCardProps) {
                    ...
                    <div className="flex-1">
                        <div className="flex items-center gap-3 flex-wrap">
                            ...
                            {record.rating && record.rating > 0 && (
                                <div className="flex items-center bg-yellow-100 text-yellow-700 px-2 py-1 rounded-full text-xs whitespace-nowrap">
