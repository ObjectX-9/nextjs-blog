  ...
  return (
    <div className="flex flex-col h-screen">
      <div className="flex justify-between items-center px-6 py-3 border-b bg-white shadow-sm">
        <h1 className="text-xl font-semibold">{articleSettings.title}</h1>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => setArticleSettings(prev => ({ ...prev, title: e.target.value }))}
                  onCompositionStart={(e: React.CompositionEvent<HTMLInputElement>) => {
                    e.currentTarget.style.backgroundColor = '#f3f4f6';
                  }}
                  onCompositionEnd={(e: React.CompositionEvent<HTMLInputElement>) => {
                    e.currentTarget.style.backgroundColor = '';
                    setArticleSettings(prev => ({ ...prev, title: e.currentTarget.value }));
                  }}
