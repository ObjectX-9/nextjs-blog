...
export default function DemosManagementPage() {
  ...
  return (
    <div className="container mx-auto p-4 h-screen overflow-hidden">
          ...
          <div className="flex flex-wrap gap-4 mb-6">
            <div className="flex-1 min-w-[200px]">
              <input
                ...
                placeholder="分类名称"
                className="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl text-gray-900 text-base placeholder:text-gray-400 focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all duration-200"
              />
            </div>
            <div className="flex-1 min-w-[200px]">
              <input
            ...
            <button
              ...
              disabled={isUpdating}
              className="px-6 py-3 bg-indigo-600 text-white rounded-xl hover:bg-indigo-700 disabled:bg-indigo-300 transition-colors duration-200 font-medium flex items-center gap-2 min-w-[120px] justify-center"
            >
              {isUpdating ? (
                <>
      ...
      {/* Add Demo Form */}
      {activeTab === "add" && (
        <div className="bg-white p-6 rounded-xl shadow-lg mb-4 overflow-y-auto max-h-[calc(100vh-180px)]">
          <h2 className="text-2xl font-bold text-gray-800 mb-6">添加新Demo</h2>
          <div className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full px-4 py-3 bg-white border border-gray-200 rounded-xl text-gray-900 text-base placeholder:text-gray-400 focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all duration-200"
            ...
            <div>
              ...
              <textarea
                ...
                className="mt-1 block w-full px-4 py-3 bg-white border border-gray-200 rounded-xl text-gray-900 text-base placeholder:text-gray-400 focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all duration-200 min-h-[120px] resize-y"
            ...
            <div>
              ...
              <div className="mt-2 flex justify-center rounded-xl border-2 border-dashed border-gray-300 px-6 py-10 hover:border-indigo-500 transition-colors duration-200">
      ...
      {editingDemo && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-4 rounded-lg w-full max-w-lg relative">
            <h2 className="text-xl font-semibold mb-4">编辑Demo</h2>
            <div className="space-y-4">
              <div>
