                    ...
                    {photo.tags && photo.tags.length > 0 && (
                        <div className="flex flex-wrap gap-1 mt-2">
                            {photo.tags.slice(0, 2).map((tag, index) => (
                                <span
                                    key={index}
                                    className="px-2 py-0.5 text-xs text-white/90 bg-white/10 backdrop-blur-md border border-white/20 rounded-full"
                                >
                                    #{tag}
                                </span>
                            ))}
                            {photo.tags.length > 2 && (
                                <span className="px-2 py-0.5 text-xs text-white/90 bg-white/10 backdrop-blur-md border border-white/20 rounded-full">
                                    +{photo.tags.length - 2}
                                </span>
                            )}
                        </div>
