...
const CustomLightbox: React.FC<CustomLightboxProps> = ({
    ...
    const dynamicBackground = useMemo(() => {
        ...
        if (currentPhoto?.analysis?.dominantColors && currentPhoto.analysis.dominantColors.length > 0) {
            colorsToUse = currentPhoto.analysis.dominantColors;
    ...
    }, [currentPhoto?.analysis?.dominantColors, extractedColors, currentPhoto?.src]);
